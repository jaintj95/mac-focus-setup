...
* Add Slack, Spotify and other non-essential apps to blacklists -> App switcher only shows what you really need for work -> You can still open/switch to these apps using Raycast or Spotlight. The added friction stops you from feeding your doom App-switching impulses
